...
public class ProductController {
    ...
    public ProductController(ProductPrint productPrint, ProductService productService) {
    ...
    public void selectAllProductList() {
        ...
        if(productList != null){
            ...
            productPrint.printErrorMessage("print");
        }
    ...
    public void registNewProduct(ProductDTO product) {
        ...
        String releaseDateInput = String.valueOf(product);
        ...
        productService1.registNewProduct(productDTO);
        boolean result= productService1.registNewProduct(product);

        if (result){
            productPrint.printSuccessMessage("success");
        }else {
            productPrint.printErrorMessage("fall");
        }
        // 4. 제품 정보를 등록하는 메소드
    ...
    public void modifyProductInfo(ProductDTO product) {
        ...
        productService1.modifyProductInfo(productDTO);
        boolean result= productService1.modifyProductInfo(productDTO);
